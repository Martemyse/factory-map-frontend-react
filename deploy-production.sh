...
FRONTEND_STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://localhost:8087/)
API_STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://localhost:8087/api/health)
TILES_STATUS=$(curl -s -o /dev/null -w "%{http_code}" http://localhost:8087/tiles/)
